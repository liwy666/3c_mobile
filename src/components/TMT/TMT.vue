<template>
	<div class="tmt-main" v-if="get_info">
		...
		<div class="goods-list-box">
			<div style="width: 33.3%" v-for="item in this.index_ad_list.ppjx_goods_list" :key="item.id"
...
<script>
    ...
    export default {
        ...
        methods: {
            getIndexAd() {
                this.$fetch("get_index_info", {into_type: 'tmt_mobile'}).then((msg) => {
                    if (msg) {
                        this.get_info = msg;
                    }
            ...
            goBack() {
                window.location.href = "https://m.mall.icbc.com.cn/index.html";
            }
        },
        components: {
            topSwiper,
