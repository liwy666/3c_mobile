<template>
	<div class="main" v-if="load_finish">
		...
		<img class="title" v-if="coupon_shop.length>0"
			src="https://mate.ganglonggou.com/lib/images/double_eleven/coupon_shop_head.png">
		<div class="cut-goods-box">
			<div class="cut-goods-item" v-for="item in coupon_shop" :key="item.id" @click="toControl(item)">
				<img :src="item.ad_img">
			</div>
		</div>
		<img class="title" v-if="characteristic_goods.length>0"
			src="https://mate.ganglonggou.com/lib/images/double_eleven/characteristic_goods_head.png">
		<div class="goods-list-box">
			<goods-card :goods_info="item" v-for="item in characteristic_goods" :key="item.id"
				:to-control="toControl"></goods-card>
		</div>
		<img class="title" v-if="selected_goods.length>0"
			src="https://mate.ganglonggou.com/lib/images/double_eleven/selected_goods_head.png">
		<div class="goods-list-box">
			<goods-card :goods_info="item" v-for="item in selected_goods" :key="item.id"
				:to-control="toControl"></goods-card>
		</div>
		...
		<img class="title" v-if="live_goods.length>0"
			src="https://mate.ganglonggou.com/lib/images/double_eleven/live_goods_head.png">
		<div class="goods-list-box">
			<goods-card :goods_info="item" v-for="item in live_goods" :key="item.id"
				:to-control="toControl"></goods-card>
		</div>
		<img class="title" v-if="kitchen_goods.length>0"
			src="https://mate.ganglonggou.com/lib/images/double_eleven/kitchen_goods_head.png">
		<div class="goods-list-box">
